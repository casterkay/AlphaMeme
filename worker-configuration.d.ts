/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fc45e6425065041b2cc718528770d4dc)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 
interface __BaseEnv_Env {
	RADAR: DurableObjectNamespace<import("./src/worker").RadarAgent>;
	TENANT_REGISTRY: DurableObjectNamespace<import("./src/worker").TenantRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "RadarAgent" | "TenantRegistry";
	}
